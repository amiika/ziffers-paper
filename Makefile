...
iclc2023.html: iclc2023.md references.bib
    pandoc -f markdown-implicit_figures --template=pandoc/iclc.html --citeproc --number-sections iclc2023.md -o iclc2023.html --pdf-engine=xelatex


iclc2023.pdf: iclc2023.md references.bib pandoc/iclc.latex pandoc/iclc.sty
    pandoc -f markdown-implicit_figures --template=pandoc/iclc.latex --citeproc --number-sections iclc2023.md -o iclc2023.pdf --pdf-engine=xelatex
