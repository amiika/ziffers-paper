...
Objectives for the presented notation have been selected by reviewing the cognitive dimensions of music notations defined by @nash2015cognitive and the desirable criteria for alternative music notations defined by the Music Notation Project [@mnma2022]. Guiding principles have been the minimalism, flexibility and learnability of the notation which enables users of different ages and backgrounds to easily experiment and compose music in a live setting. The Ziffers extension built for Sonic Pi presented in latter sections of this paper builds on the accessibility and pedagogical efforts pursued by @aaron2016sonic. The development of the numerical notation aims to remove the exclusivity that comes with the music theory and provide a beneficial live coding experience for the uninitiated. Use of numeric notation should make it possible to write melodic sequences and interval movements using numbers regardless of the key and scale. 
